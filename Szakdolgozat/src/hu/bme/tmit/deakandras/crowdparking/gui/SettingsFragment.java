	...
	public void onCreate(Bundle savedInstanceState) {
		...
		if (sharedPreferences != null) {
			...
			if (walkDistance != null) {
				walkDistance.setSummary(sharedPreferences.getString(KEY_MAX_WALK_DISTANCE_PREFERENCE, "") + ' '
						+ getResources().getString(R.string.max_walk_distance_postfix));
			}
			Preference searchTime = findPreference(KEY_MAX_SEARCH_TIME_PREFERENCE);
			if (searchTime != null) {
				searchTime.setSummary(sharedPreferences.getString(KEY_MAX_SEARCH_TIME_PREFERENCE, "") + ' '
						+ getResources().getString(R.string.max_search_time_postfix));
			}
		}
	}
